...
**Team**: Varsha Venkatapathy, Enakshi Chawla, Nalaya Giraud, Matthew Wu, Zehao Wu  
...
**Varsha Venkatapathy**: Architected and tested the preprocessing pipeline (speckle noise injection, data augmentation, image resizing) and led model development including encoder-decoder implementation, attention mechanism integration, and hyperparameter optimization.
